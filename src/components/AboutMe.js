  ...
  return (
    <div>
      ...
      <div className="text-description background-gradient slide">
        ...
        <div>
          <h2>Technology</h2>
          I initially learned to code in Java during High School and have
          enjoyed using code to solve problems ever since!
          <br />
          Next, I learned Python through online courses the summer before
          university.
          <br />
          Lastly, I taught myself JavaScript to make better websites and then
          learned React to make bigger apps!
          <br />
        ...
        <div>
          ...
          program.
          <br />
          During my studies, I took the DELF B2 test, which was the highest
          level of fluency for grade 12 students!
          <br />
        </div>
      </div>
    </div>
